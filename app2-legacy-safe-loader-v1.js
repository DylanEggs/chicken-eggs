(() => {
  ...
  try {
    ...
    xhr.open("GET", "app2-legacy-v1.js?v=20260815-safe2", false);
    xhr.send(null);
    ...
    // Farm App 2 keeps a closure-local copy called farm2. Reload it whenever
    // either a verified cloud update OR a successful local protected save
    // changes APP2_KEY, so a later action can never write an older in-memory
    // flock/expense/customer array back over the just-saved state.
