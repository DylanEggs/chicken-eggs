(() => {
  "use strict";
  if (window.__appAuditSafeLoaderV1) return;
  window.__appAuditSafeLoaderV1 = true;

  try {
    const xhr = new XMLHttpRequest();
    xhr.open("GET", "app-audit-legacy-v1.js?v=20260815-safe1", false);
    xhr.send(null);
    ...
    // Keep the authoritative customer/order/expense/flock/chore/business action
    // functions, but remove the old MutationObserver farm-list watchers. All
    // current renderers already react to local/Firebase data events.
