(() => {
  ...
  if (!native.getItem.call(local, INIT)) {
    ...
    for (const key of liveKeys) {
      try {
        ...
        if (value != null) native.setItem.call(local, stageKey(key), value);
      } catch {}
    }
  ...
  proto.setItem = function(key, value) {
    ...
    return native.setItem.call(this, stageKey(key), value);
  };
  ...
  console.log("🧪 STAGING storage sandbox active — live localStorage is isolated");
})();
