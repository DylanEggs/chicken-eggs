(() => {
  ...
  try {
    ...
    if (!source.includes('load("staging/staging-history-customer-v1.js")')) throw new Error("History customer staging layer was not injected");
