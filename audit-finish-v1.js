(()=>{"use strict";
const E="chickenEggEntriesV102",S="chickenEggSettingsV102",A="chickenEggApp2V1",I="chickenEggInventoryV2",B="chickenEggBusinessV1",D="chickenEggDeluxeV1",P="chickenEggLocalBirdPhotosV1";
const read=(k,f)=>{try{return JSON.parse(localStorage.getItem(k)||JSON.stringify(f))}catch{return f}},n=v=>Number(v)||0,money=v=>"$"+n(v).toFixed(2),esc=v=>String(v??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"}[c]));
function app(){let a=read(A,{});return{...a,customers:Array.isArray(a.customers)?a.customers:[],orders:Array.isArray(a.orders)?a.orders:[],expenses:Array.isArray(a.expenses)?a.expenses:[],flock:Array.isArray(a.flock)?a.flock:[],chores:Array.isArray(a.chores)?a.chores:[],activity:Array.isArray(a.activity)?a.activity:[],saleMeta:a.saleMeta&&typeof a.saleMeta==="object"?a.saleMeta:{},goals:a.goals&&typeof a.goals==="object"?a.goals:{},preferences:a.preferences&&typeof a.preferences==="object"?a.preferences:{},achievements:a.achievements&&typeof a.achievements==="object"?a.achievements:{}}}
function entries(){let x=read(E,[]);return Array.isArray(x)?x.filter(e=>e&&(e.type==="eggs"||e.type==="sale")):[]}
