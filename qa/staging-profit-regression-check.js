...
pass('V2 test preserves calculator inputs',v2.includes('Business refresh preserves calculator inputs'));
...
console.log('\nAll staging visible-profit regression architecture checks passed.');
